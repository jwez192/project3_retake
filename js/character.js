        ...
        option.addEventListener('click', e =>{
            ...
            switch(option.id){
                ...
                case "charTwo":
                    ...
                    <p class = "descriptionText">${characters[1].equipment.head}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[1].equipment.neck}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.neck}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[1].equipment.shoulders}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.shoulders}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[1].equipment.cloak}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.cloak}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[1].equipment.chest}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.chest}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[1].equipment.shirt}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.shirt}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[1].equipment.tabard}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.tabard}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[1].equipment.wrists}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.wrists}</p>
                    </article>`;
                    ...
                    <p class = "descriptionText">${characters[1].equipment.gloves}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[1].equipment.belt}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.belt}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[1].equipment.pants}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.pants}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[1].equipment.boots}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.boots}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[1].equipment.ringOne}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.ringOne}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[1].equipment.ringTwo}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.ringTwo}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[1].equipment.trinketOne}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.trinketOne}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[1].equipment.trinketTwo}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[1].equipment.trinketTwo}</p>
                    </article>`;
                ...
                case "charThree":
                    ...
                    <p class = "descriptionText">${characters[0].equipment.head}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[0].equipment.neck}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.neck}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[0].equipment.shoulders}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.shoulders}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[0].equipment.cloak}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.cloak}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[0].equipment.chest}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.chest}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[0].equipment.shirt}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.shirt}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[0].equipment.tabard}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.tabard}</p>
                    </article>`;
                    injectItemLeft += `<article class = "item">
                    <div id = "${characters[0].equipment.wrists}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.wrists}</p>
                    </article>`;
                    injectLocationLeft.innerHTML = injectItemLeft;

                    injectItemRight += `<article class = "item">
                    <div id = "${characters[0].equipment.gloves}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.gloves}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[0].equipment.belt}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.belt}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[0].equipment.pants}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.pants}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[0].equipment.boots}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.boots}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[0].equipment.ringOne}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.ringOne}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[0].equipment.ringTwo}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.ringTwo}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[0].equipment.trinketOne}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.trinketOne}</p>
                    </article>`;
                    injectItemRight += `<article class = "item">
                    <div id = "${characters[0].equipment.trinketTwo}" class="itemImg"></div>
                    <p class = "descriptionText">${characters[0].equipment.trinketTwo}</p>
                    </article>`;
                    injectLocationRight.innerHTML = injectItemRight;
                    break;
                case "charFour":
